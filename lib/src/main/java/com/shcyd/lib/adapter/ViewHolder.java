...
//            videoView.start();
    ...
    public void setImage(int resId, String path) {
        ...
        Glide.with(mContext).load(path).asBitmap().placeholder(R.drawable.avatar_default_lib).error(R.drawable.avatar_default_lib).centerCrop().into(new BitmapImageViewTarget(img) {
            @Override
    ...
    public void setImageVoideo(int resId, String path) {
        final ImageView img = getSubView(resId);
        Glide.with(mContext).load(path).asBitmap().placeholder(R.color.colorBg).error(R.color.colorBg).centerCrop().into(new BitmapImageViewTarget(img) {
            @Override
            protected void setResource(Bitmap resource) {
                RoundedBitmapDrawable circularBitmapDrawable =
                        RoundedBitmapDrawableFactory.create(mContext.getResources(), resource);
