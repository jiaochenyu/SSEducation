...
import com.ss.education.customview.DragPhotoView;
...
public class DragPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
        mList = getIntent().getStringArrayListExtra("pathList");
...
//        mList.add("path");
        ...
        for (int i = 0; i < mPhotoViews.length; i++) {
            mPhotoViews[i] = (DragPhotoView) View.inflate(this, R.layout.item_photo_viewpager, null);
            Glide.with(this).load(mList.get(i)).placeholder(R.drawable.pic_fail).error(R.drawable.pic_fail).into(mPhotoViews[i]);
