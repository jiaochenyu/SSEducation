...
public class AudioRecordButton extends Button implements AudioManager.AudioStageListener {
    ...
    public AudioRecordButton(Context context, AttributeSet attrs) {
        ...
        // 已经判断内存卡是否存在的问题。录音已经放到了缓存目录，下次启动【APP进程】时会删除以前所有录音。
        String dir = LHFileUtils.getTempDir(getContext()) + "/recorder";
        ...
        setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                //最多只能录制三条
//                if (hasRecordCount >= 3) {
//                    Toast.makeText(getContext(), getContext().getString(R.string.max_voice_record), Toast.LENGTH_SHORT).show();
//                    return false;
//                }
        ...
        public void run() {
            ...
            while (isRecording) {
                try {
                    ...
                    //最长60s
                    if (mTime > 60) {
                        mhandler.sendEmptyMessage(MSG_VOICE_STOP);
                        return;
                    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_DIALOG_DIMISS:
                    ...
                    break;
                case MSG_VOICE_STOP:
                    // setBackgroundDrawable(getResources().getDrawable(R.drawable.fabuxuanshang_yuyin_def));
                    isOverTime = true;//超时
                    ...
                    hasRecordCount++;
                    reset();// 恢复标志位
                    Toast.makeText(getContext(), getContext().getString(R.string.max_voice_time), Toast.LENGTH_LONG).show();
                    break;
    ...
    private void changeState(int state) {
        ...
        if (mCurrentState != state) {
            ...
            switch (mCurrentState) {
                case STATE_NORMAL:
                    setBackgroundResource(R.drawable.icon_yuyin_def);
                    setText("");
                    break;
