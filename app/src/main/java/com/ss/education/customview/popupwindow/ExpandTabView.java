package com.ss.education.customview.popupwindow;
...
import com.ss.education.listener.PopViewBaseActionListener;
import com.ss.education.utils.PopUIHelper;
...
public class ExpandTabView extends LinearLayout implements OnDismissListener{
	...
	private PopToggleButton selectedButton;
	private int selectPosition;
	private List<PopToggleButton> mToggleButton = new ArrayList<PopToggleButton>();
...
//			r.setAlpha(0.0f);
			mViewArray.add(r);
			r.setTag(SMALL);
			PopToggleButton tButton = (PopToggleButton)inflater
			...
			tButton.setOnToggleListener(new PopToggleButton.OnToggleListener() {
				...
				public void onClick(View v) {
					...
					PopToggleButton tButton = (PopToggleButton)v;
