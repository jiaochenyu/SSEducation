...
public class PopListTextAdapter extends ArrayAdapter<String> {
	 ...
	 * @param nId //����δѡ��״̬����ͼƬ
	 */
	public PopListTextAdapter(Context context, List<String> listData, int sId, int nId, int type) {
	...
	public PopListTextAdapter(Context context, String[] arrayData, int sId, int nId, int type) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(mContext)
					.inflate(R.layout.item_popuwindow, parent, false);
