 ...
 */
public class AddressPicker2 extends WheelPicker {
...
//    private int selectedCountyIndex = 0;
    ...
    public AddressPicker2(Activity activity, ArrayList<Province> data) {
        super(activity);
...
//        LogUtils.debug(String.format("init select index: %s-%s-%s", selectedProvinceIndex, selectedCityIndex, selectedCountyIndex));
    ...
    protected View initContentView() {
        ...
        provinceView.setLayoutParams(new LinearLayout.LayoutParams(screenWidth / 2, WRAP_CONTENT));
        ...
        cityView.setLayoutParams(new LinearLayout.LayoutParams(screenWidth / 2, WRAP_CONTENT));
        ...
        super.setOnConfirmListener(new OnConfirmListener() {
            ...
            public void onConfirm() {
                if (onAddressPickListener != null) {
                    onAddressPickListener.onAddressPicked(selectedProvince, selectedCity);
                }
            }
        });
    }
